        ...
        <div class="da-panel collapsible">
            <div class="da-panel-header">
                <span class="da-panel-title">
                    <i class="icol-<?php echo ($content_categories->GetPrimary() != '') ? 'application-edit' : 'add'?>"></i> <?php echo ($content_categories->GetPrimary() != '') ? 'แก้ไข' : 'เพิ่ม'?> หมวดหมู่บทความ
                </span>
            </div>
...
<div class="row-fluid">	
    <div class="span12"> 
        ...
        <div class="da-panel collapsible">
            <div class="da-panel-header">
                <span class="da-panel-title">
                    <i class="icol-grid"></i> หมวดหมู่บทความ ทั้งหมด
                </span>
            </div>
