                ...
                <div class="da-panel-content da-form-container">
                    <form id="validate" enctype="multipart/form-data" action="<?php echo ADDRESS_ADMIN_CONTROL ?>contact<?php echo ($contact->GetPrimary() != '') ? '&id=' . $contact->GetPrimary() : ''; ?>" method="post" class="da-form">
                        ...
                        <div class="da-form-inline">
                            <fieldset class="da-form-inline">
                                ...
                                <div class="da-form-row hidden">
                                    ...
                                    <div class="da-form-item large">
                                        <input type="text" name="contact_title" id="" value="<?php echo ($contact->GetPrimary() != '') ? $contact->GetValue('contact_title') : ''; ?>" class="span12" />
                                    </div>
                                </div>
                            ...
                            <fieldset class="da-form-inline">
                                <legend> GOOGLE MAP CODE</legend>
                                <div class="da-form-row">
                                    <label class="da-form-label">GOOGLE MAP CODE</label>
                                    <div class="da-form-item large">
                                        <textarea name="google_map" id="google_map" class="span12"><?php echo ($contact->GetPrimary() != '') ? $contact->GetValue('google_map') : ''; ?></textarea>
                                    </div>
                                </div>
                                <div class="da-form-row">
                                    <label class="da-form-label">MAP VIEW</label>
                                    <div class="da-form-item large">
                                        <?php echo ($contact->GetPrimary() != '') ? $contact->GetValue('google_map') : ''; ?>
                                    </div>
                                </div>
                            </fieldset>
