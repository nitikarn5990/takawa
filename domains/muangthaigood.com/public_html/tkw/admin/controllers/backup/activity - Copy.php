   ...
   $activity->SetValues($arrData);
    ...
    if ($activity->Save()) {
        ...
        if ($redirect) {
            ...
            header('location:' . ADDRESS_ADMIN_CONTROL . 'contents&action=edit&id=' . $activity->GetPrimary());
            die();
        }
    } else {
        SetAlert('ไม่สามารถเพิ่ม แก้ไข ข้อมูลได้ กรุณาลองใหม่อีกครั้ง');
...
<?php if ($_GET['action'] == "add" || $_GET['action'] == "edit") { ?>
                        ...
                        <div class="da-form-inline">
                            ...
                            <fieldset class="da-form-inline">
                                ...
                                <div class="da-form-row">
                                    ...
                                    <div class="da-form-item large">
                                        <input id="input-3" type="file" class="file" name="cover_img_array" data-show-upload="false" data-show-caption="true">
    ...
    ?>
                            ...
                            <div class="da-form-row">
                                ...
                                <div class="da-form-item large">
                                    <input type="text" name="activity_date" id="activity_date" value="<?php echo $activity->GetValue('activity_date') ?>" class="span12 required" />
                                </div>
                            </div>
                        </div>
                        <div class="btn-row">
    ...
    ?>
            <div class="da-panel collapsible">
                ...
                <div class="da-panel-content da-table-container">
                    <table id="da-ex-datatable-sort" class="da-table" sort="0" order="asc" width="1200">
                        <thead>
                            <tr>
                                <th>รหัส</th>
                                <th>รูป</th>
    ...
    while ($row = $db->FetchArray($query)) {
        ?>
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a class="fancybox" href="<?php echo $row['cover_img'] == '' ? NO_IMAGE : ADDRESS_COVER . $row["cover_img"] ?>">
